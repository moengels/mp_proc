...
class phase_structure: 
    ...
    def __init__(self):
        ...
        self.optics_dz = 0.610          # axial sampling [um]
        self.optics_NA = 1.3          # Numerical Aperture detection (Olympus 60x silicone objective UPLSAPO60XS2) 
        self.optics_NA_ill =  0.287    # Numerical Aperture illumination (Olympus IX2-LWUCD condenser)
        self.optics_n = 1.406          # refractive index (Olympus silicone) 
        self.optics_wv = 0.525          # Central wavelength in vacuum/ WAS optics.lambda (py internal command)
        self.optics_dlambda = 0.050   # Spectrum bandwidth
        self.optics_alpha =   3.1   # Experimental coefficient for QP "normalisation" optimised for TUD/MCL setup
